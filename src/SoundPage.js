...
function SoundPage() {
  return (
    ...
    >
      {/* Padding row same as above the Artist Statement in AboutPage */}
      ...
      <Row>
        <Col md={12}>
          ...
          >
            ...
            {/* Padding between the title and the description */}
            <p style={{ textAlign: 'left', fontSize: '100%', marginTop: '35px' }}>
            ...
            <p style={{ textAlign: 'left', fontSize: '100%', marginTop: '20px' }}>
            ...
            {/* Audio player inserted at the bottom with 80% opacity */}
